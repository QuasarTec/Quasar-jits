Connect - redux state persistence
====================================
Connect has a persistence layer that persists specific subtrees of the redux
...
When it's done, Connect will automatically persist these subtrees and
