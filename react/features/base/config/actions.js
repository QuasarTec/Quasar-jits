...
/**
 * Signals that the configuration (commonly known in Connect as config.js)
...
/**
 * Signals that a configuration (commonly known in Connect as config.js)
...
/**
 * Stores a specific Connect config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Connect config.js to store.
 * @returns {Function}
 */
