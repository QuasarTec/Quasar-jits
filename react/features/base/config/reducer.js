 ...
 * JitsiMeetJS#init(). The app will download config.js from the Connect
 ...
 * The app will download config.js from the Connect deployment and take its
 ...
 * config.js from the Connect deployment and take its values into account but
...
function _setConfig(state, { config }) {
    ...
    const newState = _.merge(
        ...
        // downloaded from the Connect deployment because the former contains
