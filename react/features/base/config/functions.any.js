...
/**
 * Restores a Connect config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Connect config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Connect"
    // }
    // We want to have:
    // json = {
    //     config: {
