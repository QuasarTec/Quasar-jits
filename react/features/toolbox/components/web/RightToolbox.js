 ...
 * @extends Component
 */
class RightToolbox extends Component<Props> {
    /**
    ...
    */
    ...
    _renderToolboxContent() {
        ...
        return (
            <div
                className = { `mobile-toolbox ${this.props._visible && 'visible'}` }>
                <div className = { `${containerClassName} sound` }>
                    <div
                ...
                <div className = { `${containerClassName} additional` }>
...
export default translate(connect(_mapStateToProps)(RightToolbox));
