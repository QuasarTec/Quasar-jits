			...
			<div
				...
				<footer className='footer-info'>
					<div className='container left'>
						...
						<img className='qcloud'
							src='../../../../images/qcloud.svg' />
					...
					<div className='container center'>
						...
						<a className='policy'>Ознакомьтесь c <span className='underline'>политикой конфиденциальности</span></a>
						<p className='copyright'>Copyright © 2022. All rights reserved by Zero Gravity Foundation Pte. Ltd.<br />Registration no: 202137914H, Incorporated in the Republic of Singapore.</p>
					</div>
					<div className='container right'>
						<img src='../../../../images/logo-zero.png' />
					</div>
				</footer>
