...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Connect in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Connect.
     *
    ...
    /**
     * Getter for participant specific video element in Connect.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Connect
    ...
    /**
     * Removes the listeners and removes the Connect frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Connect.
     *
